    ...
    <>
      <div className="footer-bg" id="footer">
        <footer className="divide-y pt-24">
          <div className="container grid md:grid-cols-3 grid-cols-1 py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div>
              ...
              <div className="space-y-3 ">
                <button className=" flex md:justify-start items-center mx-auto md:mx-0 bg-[#092943] px-8 py-4">
                  <span className="text-white border-r-2 border-white pr-4">
                    Hotline:
                  </span>
                  <span className="text-white pl-4">0937 641 678</span>
                </button>
                <div className="flex justify-center md:justify-start space-x-3">
                  <a
                    ...
                    href=""
                    title="Facebook"
                    className="flex items-center p-1 text-gray-800 hover:text-[#A29061]"
                  >
                    <svg
          ...
          <div className="container mx-auto grid py-6 justify-center items-center">
